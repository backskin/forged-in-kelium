    ...
    public static final class ОпорныйПункт extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Опорный пункт", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.БОЙ,
                "Имей на поле 2 свои вышки на разных гексах, и обе не на гексе с "
                + "ЦУ, — награда бесплатный Бой. Если одна из вышек стоит на гексе с "
                + "жетонами врага, условие усилено: 2 боеприпаса. Вышка не двигается "
                + "вовсе, поэтому опорный пункт выбирают один раз и навсегда.");
        }
    ...
    public static final class Засада extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Засада", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.РИКОШЕТ,
                "Имей военное здание с войском внутри, по соседству с гексом, где "
                + "есть жетоны врага, — награда бесплатный Манёвр. Держи так сразу "
                + "два войска, и условие усилено: 1 боеприпас. Гарнизон в здании не "
                + "виден до первого выстрела.");
        }
    ...
    public static final class ПередоваяБаза extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Передовая база", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.действием("assembly"),
                Награда.монеты(1),
                Утиль.РАЗВЁРТЫВАНИЕ,
                "В ЭТОТ ХОД построй своё здание на гексе, соседнем с гексом, где "
                + "есть войска противника, — награда бесплатное Снаряжение. Построй "
                + "его на гексе, соседнем с гексом, где есть здание противника, и "
                + "условие усилено: 1 монета. Передовая база строится под огнём — "
                + "потому и платит.");
        }
    ...
    public static final class НаглаяСтройка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Наглая стройка", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "На этом гексе два и более жетонов врага",
                Награда.действием("build"),
                Награда.монеты(2),
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "В ЭТОТ ХОД построй своё здание на гексе, где стоит войско врага, — "
                + "награда бесплатная Стройка. Если на этом гексе два и более жетонов "
                + "врага, условие усилено: 2 монеты. Стройка под чужим стволом — "
                + "заявка, а не расчёт.");
        }
    ...
    public static final class ШтабНаПередовой extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Штаб на передовой", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.РАЗВЁРТЫВАНИЕ,
                "Имей своё здание на гексе, соседнем с гексом, где стоит ЦУ "
                + "противника, — награда бесплатное Снаряжение. Если таких твоих "
                + "зданий два и стоят они на разных гексах, условие усилено: 1 монета. Подобраться стройкой к чужому штабу дороже, чем кажется: "
                + "туда ещё надо дойти, и там по тебе будут бить.");
        }
    ...
    public static final class ПерваяКровь extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Первая кровь", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.РАЗВЁРТЫВАНИЕ,
                "В ЭТОТ ХОД уничтожь два жетона противника — награда два "
                + "спец-действия в этот ход. Если у одного из них прочность была 2 "
                + "или больше, условие усилено: 1 карта задания. Первая кровь "
                + "считается по двум, а не по одному.");
        }
    ...
    public static final class Осада extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Осада", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.боеприпасы(1),
                Утиль.БОЙ,
                "Имей среди уничтоженных жетонов жетон врага — награда бесплатный "
                + "Манёвр. Если их два и один из них добытчик, условие усилено: 1 боеприпас. Снесённая экономика соседа стоит дороже снесённой "
                + "казармы.");
        }
