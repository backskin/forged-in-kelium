    ...
    public static final class ПередоваяБаза extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Передовая база", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                + "здание противника",
                Награда.боеприпасы(3).иКартыАрсенала(1), Награда.обломки(2),
                "СВОБОДНОЕ ДВИЖЕНИЕ",
                "В ЭТОТ ХОД построй своё здание на гексе, соседнем с гексом, где "
                + "есть войска противника, — награда 3 боеприпаса и карта арсенала. "
                + "Построй его на гексе, соседнем с гексом, где есть здание "
                + "противника, и условие усилено: 2 обломка. Передовая база строится "
    ...
    public static final class ПерваяКровь extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Первая кровь", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                + "у одного из них прочность была 2 или больше, условие усилено: "
                + "жетон модуля атаки и карта задания. Первая кровь считается по "
                + "двум, а не по одному.");
        }
