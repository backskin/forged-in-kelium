    ...
    public static final class ОпорныйПункт extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Опорный пункт", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                + "жетонами врага, условие усилено: 1 трофей и спец-действие. Вышка не двигается "
    ...
    public static final class ШтабНаПередовой extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Штаб на передовой", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                + "зданий два и стоят они на разных гексах, условие усилено: 1 трофей и спец-действие. Подобраться стройкой к чужому штабу дороже, чем кажется: "
