    ...
    public static final class ОпорныйПункт extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Опорный пункт", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.действием("combat"), Награда.трофеи(2),
                Утиль.БОЙ,
                "Имей на поле 2 свои вышки на разных гексах, и обе не на гексе с ЦУ, — "
                + "награда 3 боеприпаса. Если одна из вышек стоит на гексе с жетонами "
                + "врага, условие усилено: 2 трофея. Вышка не двигается вовсе, поэтому "
                + "опорный пункт выбирают один раз и навсегда.");
        }
    ...
    public static final class Засада extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Засада", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.РИКОШЕТ,
                "Имей военное здание с войском внутри, по соседству с гексом, где "
                + "есть жетоны врага, — награда бесплатный Манёвр. Держи так сразу два войска, "
    ...
    public static final class ПередоваяБаза extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Передовая база", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                + "войска противника, — награда бесплатное Снаряжение. Построй его на гексе, соседнем с "
    ...
    public static final class НаглаяСтройка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Наглая стройка", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.действием("build"), Награда.трофеи(2),
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "В ЭТОТ ХОД построй своё здание на гексе, где стоит войско врага, — "
                + "награда 4 монеты. Если на этом гексе два и более жетонов врага, "
    ...
    public static final class ШтабНаПередовой extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Штаб на передовой", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.действием("assembly"), Награда.трофеи(2),
                Утиль.РАЗВЁРТЫВАНИЕ,
                "Имей своё здание на гексе, соседнем с гексом, где стоит ЦУ "
                + "противника, — награда бесплатное Снаряжение. Если таких твоих зданий два и "
    ...
    public static final class ПерваяКровь extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Первая кровь", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.спецДействиями(2), Награда.модуль("attack"),
                Утиль.РАЗВЁРТЫВАНИЕ,
                "В ЭТОТ ХОД уничтожь два жетона противника — награда два спец-действия в этот ход. Если "
    ...
    public static final class Осада extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Осада", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.действием("movement"), Награда.модуль("attack"),
                Утиль.БОЙ,
                "Имей среди уничтоженных жетонов жетон врага — награда бесплатный Манёвр"
