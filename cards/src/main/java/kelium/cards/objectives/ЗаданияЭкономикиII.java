    ...
    public static final class Стройбум extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Стройбум", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.ДВИЖЕНИЕ,
                "В ЭТОТ ХОД построй 2 здания на разных гексах — награда на выбор: Смена "
                + "энергии или Добыча. Усиление — 3 здания на разных и несоседних между "
                + "собой гексах: 1 трофей и спец-действие.");
        }
    ...
    public static final class ПолнаяНагрузка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Полная нагрузка", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.РАЗВЁРТЫВАНИЕ,
                "Все твои здания, требующие энергию, запитаны (не менее 3) — награда на "
                + "выбор: Снаряжение или Наука. Усиление — Не менее 4 зданий: карта "
                + "арсенала и спец-действие.");
        }
    ...
    public static final class Коммутация extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Коммутация", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                "Имей на двух зданиях - источниках энергии ровно один свободный кубик — "
                + "награда на выбор: Стройка или Рынок. Усиление — На трех источниках "
                + "энергии: 1 трофей и спец-действие.");
        }
