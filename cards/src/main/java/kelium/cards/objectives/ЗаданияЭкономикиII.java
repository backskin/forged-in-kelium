    ...
    public static final class Стройбум extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Стройбум", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "В ЭТОТ ХОД выполни две строительные операции на двух гексах, не соседних "
                + "между собой, — награда 3 боеприпаса. Выполни три операции на трёх "
                + "попарно несоседних гексах, и условие усилено: 1 трофей. Зона стройки "
                + "растёт от твоих стенок, поэтому разъехаться дороже, чем прирасти.");
        }
    ...
    public static final class ПолнаяНагрузка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Полная нагрузка", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                "Не имей на поле ни одного незапитанного здания, при этом зданий у тебя "
                + "не меньше трёх, — награда 3 монеты. Доведи число зданий до четырёх, "
                + "сохранив запитанность всех, и условие усилено: 1 карта арсенала. Пустая "
                + "ячейка ЭНР закрывается монетой только на одно действие — на состояние "
                + "это не работает.");
        }
