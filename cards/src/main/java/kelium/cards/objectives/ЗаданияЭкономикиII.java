    ...
    public static final class Переезд extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Переезд", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                + "монеты. Если одно из перенесённых — твоё ЦУ, условие усилено: 2 "
                + "обломка и карта задания. ЦУ переносится не чаще раза за ход, так "
    ...
    public static final class ПолнаяНагрузка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Полная нагрузка", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.монеты(2).иКартыАрсенала(1), Награда.картыЗаданий(1),
                "+1 К СКОРОСТИ ОДНОГО РОДА ДО КОНЦА ХОДА",
                "Не имей на поле ни одного незапитанного здания, при этом зданий у "
                + "тебя не меньше трёх, — награда 2 монеты и карта арсенала. Доведи "
    ...
    public static final class Коммутация extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Коммутация", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                + "арсенала. Простой кубик лежит на своём источнике, а собрать его "
