    ...
    public static final class ПолныйЗалп extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Полный залп", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "В ЭТОТ ХОД произведи только боеприпасы и ни одного войска — "
                + "награда бесплатный Рынок. Если эти здания - завод и авиабаза, "
                + "условие усилено: 1 келемий. Ход без единого нового войска — цена "
                + "полного залпа.");
        }
    ...
    public static final class Конвейер extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Конвейер", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.монеты(1),
                Утиль.БОЙ,
                "В ЭТОТ ХОД найми два войска разных родов — награда бесплатная "
                + "Добыча. Если среди нанятых есть авиация и нет ни одной вышки, "
                + "условие усилено: 1 монета. Авиабаза требует трёх кубиков энергии — "
                + "конвейер до неё ещё надо дотянуть.");
        }
    ...
    public static final class Жила extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Жила", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                + "разным зарождениям, — награда бесплатная Добыча. Если оба "
                + "примыкают к большим зарождениям, условие усилено: 1 монета. Своё "
                + "зарождение вырабатывают все, чужое — только те, кто дотянулся.");
        }
    ...
    public static final class Выработка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Выработка", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.монеты(1),
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "В ЭТОТ ХОД забери последний келемий с зарождения — награда "
                + "бесплатная Добыча. Если ты исчерпал зарождение и оно ушло с поля, "
                + "условие усилено: 1 монета. Исчерпанное зарождение приближает конец "
    ...
    public static final class РазведкаНедр extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разведка недр", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                "В ЭТОТ ХОД забери контейнер (добытчиком или войском)",
                null,
                Награда.действием("market"), Награда.нет(),
                Утиль.РАЗВЁРТЫВАНИЕ,
                "В ЭТОТ ХОД забери контейнер (добытчиком или войском) — награда "
                + "бесплатный Рынок. Усиления у карты нет. Каждый добытчик в Добыче "
                + "выбирает одно: келемий или контейнер, а войско берёт контейнер, "
                + "войдя на его ячейку.");
        }
        ...
        @Override
        public boolean satisfied(CardContext ctx) {
            return ход(ctx).containersTaken >= 1;
        }
