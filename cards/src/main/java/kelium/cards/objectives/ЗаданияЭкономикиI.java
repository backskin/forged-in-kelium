    ...
    public static final class ПолныйЗалп extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Полный залп", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "В ЭТОТ ХОД произведи только боеприпасы и ни одного войска — награда на "
                + "выбор: Бой или Смена энергии. Усиление — Эти здания - завод и "
                + "авиабаза: карта арсенала и спец-действие.");
        }
    ...
    public static final class Конвейер extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Конвейер", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.нет(),
                Утиль.БОЙ,
                "В ЭТОТ ХОД найми два войска разных родов — награда на выбор: Рынок или "
                + "Манёвр. Усиления у карты нет.");
        }
    ...
    public static final class Жила extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Жила", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                + "разным зарождениям — награда на выбор: Добыча или Наука. Усиление — "
                + "Оба примыкают к большим зарождениям: жетон модуля атаки и "
                + "спец-действие.");
        }
    ...
    public static final class Выработка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Выработка", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "В ЭТОТ ХОД забери последний келемий с зарождения — награда на выбор: "
                + "Рынок или Стройка. Усиление — ты исчерпал зарождение - оно ушло с "
                + "поля: жетон модуля сборки и спец-действие.");
        }
    ...
    public static final class РазведкаНедр extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разведка недр", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.РАЗВЁРТЫВАНИЕ,
                "В ЭТОТ ХОД забери контейнер (добытчиком или войском) — награда на "
                + "выбор: Стройка или Снаряжение. Усиления у карты нет.");
        }
