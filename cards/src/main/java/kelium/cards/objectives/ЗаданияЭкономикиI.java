    ...
    public static final class РазведкаНедр extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разведка недр", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.РАЗВЁРТЫВАНИЕ,
                "В ЭТОТ ХОД забери 3 контейнера (добытчиками или войсками) — "
                + "награда бесплатный Рынок. Усиления у карты нет: три контейнера за "
                + "ход и так работа всей смены. Каждый добытчик в Добыче выбирает "
                + "одно: келемий или контейнер.");
        }
