    ...
    public static final class ПолныйЗалп extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Полный залп", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "ДЕСАНТ: размести до 2 войск разных родов в своей зоне стройки",
                "В ЭТОТ ХОД действием Снаряжение произведи боеприпасы не меньше чем "
    ...
    public static final class Жила extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Жила", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.монеты(3).иКартыАрсенала(1), Награда.обломки(1),
                "СВОБОДНОЕ ДВИЖЕНИЕ",
                "Имей запитанными два своих добытчика, примыкающих к разным тайлам "
                + "зарождения, — награда 3 монеты и карта арсенала. Если оба "
                + "примыкают к нестартовым тайлам зарождения, условие усилено: "
                + "обломок. Своё зарождение вырабатывают все, чужое — только те, кто "
                + "дотянулся.");
        }
