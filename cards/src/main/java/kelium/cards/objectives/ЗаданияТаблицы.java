...
public final class ЗаданияТаблицы {
     ...
     *
     * <p>УСИЛЕННАЯ НАГРАДА — 2 ТРОФЕЯ. В таблице дизайнера у этой карты она
     * пустовала, и за три трека платили столько же, сколько за два; сам
     * дизайнер назвал это пропуском. Трофеи выбраны потому, что карта их и
     * тратит: третий трек стоит ещё одной сдачи, и часть её возвращается.
     */
    public static final class РазносТрофеев extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разнос трофеев", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "На трёх треках",
                Награда.картыЗаданий(2), Награда.трофеи(2),
                Утиль.АТАКА_ОДНИМ_ВОЙСКОМ,
                "В ЭТОТ ХОД сдай трофеи на двух разных треках технологий — награда "
                + "2 карты задания. На трёх треках условие усилено: 2 трофея. Одно "
