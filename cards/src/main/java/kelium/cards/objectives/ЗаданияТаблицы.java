...
public final class ЗаданияТаблицы {
    ...
    public static final class ГолыйЗапас extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Голый запас", ОБЫЧНАЯ, СОСТОЯНИЕ,
                "Имей в запасе 0 войск одного вида",
                "Двух видов",
                Награда.спецДействиями(2),
                Награда.картыЗаданий(1),
                Утиль.ДВИЖЕНИЕ,
                "Имей в запасе 0 войск одного вида — награда два спец-действия в "
                + "этот ход. Если так стоят сразу два рода, условие усилено: 1 карта задания. Вывести род целиком значит подставить его целиком: в "
                + "запасе не осталось никого, кем заменить убитого.");
        }
     ...
     *
     * <p>Одно действие Науки берёт СКОЛЬКО УГОДНО разных треков, по одному шагу
     * на каждом (уточнение дизайнера 09.09.2026, ключ {@code
     * tech.tracks_per_action}), поэтому два трека — это один заход в науку, но
     * оплаченный трофеями дважды. Прежде свод разрешал один трек за действие, и
     * карта была невыполнима: два действия Науки в один ход не помещаются.
     *
     * <p>УСИЛЕННАЯ НАГРАДА — КАРТА АРСЕНАЛА. В таблице дизайнера она пустовала,
     * и за три трека платили столько же, сколько за два; сам дизайнер назвал
     * это своим пропуском. Трофеями платить нельзя: карта их и ТРАТИТ, и
     * награда трофеями возвращала бы игроку только что сданное — кешбэк, а не
     * награда (замечание дизайнера 09.09.2026).
     */
    public static final class РазносТрофеев extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разнос трофеев", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "На трёх треках",
                Награда.действием("market"),
                Награда.келемий(1),
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "В ЭТОТ ХОД сдай трофеи на двух разных треках технологий — награда "
                + "бесплатный Рынок. На трёх треках условие усилено: 1 келемий. Одно "
                + "действие Науки берёт сколько угодно разных треков, по шагу на "
                + "каждом, — но каждый шаг оплачивается трофеями отдельно.");
        }
    ...
    public static final class Перестройка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Перестройка", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.действием("build"),
                Награда.монеты(2),
                Утиль.ДВИЖЕНИЕ,
                "В ЭТОТ ХОД снеси своё здание и построй другое — награда бесплатная "
                + "Стройка. Если построенное встало на тот же гекс, где стояло "
                + "снесённое, условие усилено: 2 монеты. Здание не переезжает: его "
    ...
    public static final class Списание extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Списание", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                null,
                Награда.действием("science"), Награда.нет(),
                Утиль.ЗАГРАДИТЕЛЬНЫЙ_ОГОНЬ,
                "Сбрось карту арсенала — награда бесплатная Наука. Карта арсенала "
                + "стоит места на планшете; иногда выгоднее продать её, чем искать, "
                + "куда установить.");
        }
    ...
    public static final class Разрядка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Разрядка", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                "Сдай в общий запас 2 боеприпаса — награда бесплатная Наука. "
                + "Остаться без патронов страшно ровно до тех пор, пока по тебе не "
                + "начали стрелять.");
        }
    ...
    public static final class Бронебой extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Бронебой", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.действием("combat"),
                Награда.боеприпасы(2),
                Утиль.БОЙ,
                "В ЭТОТ ХОД уничтожь технику или авиацию врага — награда бесплатный "
                + "Бой. Если снял ещё два любых чужих жетона, условие усилено: 2 боеприпаса. Техника и авиация дороже прочего и стоят дальше от "
                + "чужих стен: до них ещё надо дотянуться.");
        }
    ...
    public static final class ЗачисткаГекса extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Зачистка гекса", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.боеприпасы(2),
                Утиль.БОЙ,
                "В ЭТОТ ХОД уничтожь все жетоны врага на одном гексе — награда "
                + "бесплатный Бой. Если их там было не меньше трёх, условие усилено: 2 боеприпаса. Вычистить гекс целиком — работа не одного выстрела: "
    ...
    public static final class Обесточивание extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Обесточивание", ОБЫЧНАЯ, СОСТОЯНИЕ,
                "Имей среди уничтоженных жетонов два жетона врага",
                "Один из них — энергостанция",
                Награда.действием("movement"),
                Награда.боеприпасы(1),
                Утиль.ДВИЖЕНИЕ,
                "Имей среди уничтоженных жетонов два жетона врага — награда "
                + "бесплатный Манёвр. Если один из них энергостанция, условие "
                + "усилено: 1 боеприпас. Энергостанция питает всё остальное, поэтому "
                + "её снос стоит противнику дороже собственной цены.");
        }
    ...
    public static final class ДвеВойны extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Две войны", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.действием("science"),
                Награда.трофеи(2),
                Утиль.ДВИЖЕНИЕ,
                "Имей среди уничтоженных жетонов жетоны двух разных противников — "
                + "награда бесплатная Наука. Если оба этих жетона здания, условие "
                + "усилено: 2 трофея. Единственная карта колоды, которую нельзя "
    ...
    public static final class ПротивСильнейшего extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Против сильнейшего", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                + "чем у тебя",
                "В ЭТОТ ХОД уничтоженный жетон был техникой или авиацией",
                Награда.действием("science"),
                Награда.трофеи(2),
                Утиль.ДВИЖЕНИЕ,
                "В ЭТОТ ХОД уничтожь жетон игрока, у которого на поле больше войск, "
                + "чем у тебя, — награда бесплатная Наука. Если уничтоженный был "
                + "техникой или авиацией, условие усилено: 2 трофея. Бить сильнейшего "
                + "значит получить сдачи, и карта платит именно за это.");
        }
    ...
    public static final class Диверсия extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Диверсия", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.действием("mining"),
                Награда.монеты(1),
                Утиль.ОБМЕН_НАУКА_ИЛИ_РЫНОК,
                "В ЭТОТ ХОД уничтожь энергостанцию противника — награда бесплатная "
                + "Добыча. Если это была энергостанция третьего или четвёртого "
                + "уровня, условие усилено: 1 монета. Крупные энергостанции стоят в "
                + "глубине, и лезть за ними опасно.");
        }
    ...
    public static final class Энергосеть extends ВсеЗданияРода {
        ...
        public Лицо лицо() {
            return new Лицо("Энергосеть", ОБЫЧНАЯ, СОСТОЯНИЕ,
                "Имей на поле все свои 4 здания энергостанций", null,
                Награда.действием("build"), Награда.нет(),
                Утиль.ДВИЖЕНИЕ,
                "Имей на поле все свои 4 здания энергостанций — награда бесплатная "
                + "Стройка. Полный комплект источников на поле — лучшая мишень в "
                + "партии: их нечем прикрыть и негде спрятать.");
        }
    }
    ...
    public static final class РудныйДвор extends ВсеЗданияРода {
        ...
        public Лицо лицо() {
            return new Лицо("Рудный двор", ОБЫЧНАЯ, СОСТОЯНИЕ,
                "Имей на поле все свои 4 здания добытчиков", null,
                Награда.действием("build"), Награда.нет(),
                Утиль.ДВИЖЕНИЕ,
                "Имей на поле все свои 4 здания добытчиков — награда бесплатная "
                + "Стройка. Разложил всё, чем добываешь, — держи оборону или жги "
                + "карту: у добытчика прочность один.");
        }
    }
    ...
    public static final class Расселение extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Расселение", ОБЫЧНАЯ, СОСТОЯНИЕ,
                "Займи 4 разных гекса войсками хотя бы 2 видов",
                "6 гексов",
                Награда.действием("market"),
                Награда.келемий(1),
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "Займи 4 разных гекса войсками хотя бы 2 видов — награда бесплатный "
                + "Рынок. 6 гексов, и условие усилено: 1 келемий. Растянуться по полю "
                + "выгодно и опасно разом: где тонко, там и порвут.");
        }
    ...
    public static final class Растяжка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Растяжка", ОБЫЧНАЯ, СОСТОЯНИЕ,
                "Займи войсками 5 разных гексов",
                "На 2 из них есть здания противника",
                Награда.действием("science"),
                Награда.трофеи(2),
                Утиль.РЕМОНТ_ГЕКСА,
                "Займи войсками 5 разных гексов — награда бесплатная Наука. Если на "
                + "двух из них есть здания противника, условие усилено: 2 трофея. "
                + "Гекс с чужим зданием закрыт: стоять там можно, бить оттуда — "
                + "только по зданиям и вышкам.");
        }
