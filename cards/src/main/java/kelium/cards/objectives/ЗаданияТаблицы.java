    ...
    public static final class ГолыйЗапас extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Голый запас", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                "Двух видов",
                Награда.спецДействиями(2), Награда.трофеи(2),
                Утиль.ДВИЖЕНИЕ,
                "Имей в запасе 0 войск одного вида — "
    ...
    public static final class РазносТрофеев extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разнос трофеев", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "На трёх треках",
                Награда.действием("market"), Награда.картаАрсенала(),
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "В ЭТОТ ХОД сдай трофеи на двух разных треках технологий — награда бесплатный Рынок"
                + "2 карты задания. На трёх треках условие усилено: 1 карта арсенала. "
                + "Одно действие Науки берёт сколько угодно разных треков, по шагу на "
    ...
    public static final class Перестройка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Перестройка", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.действием("build"), Награда.трофеи(1),
                Утиль.ДВИЖЕНИЕ,
                "В ЭТОТ ХОД снеси своё здание и построй другое — награда бесплатная Стройка"
    ...
    public static final class Списание extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Списание", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                "Сбрось карту арсенала — награда бесплатная Наука"
                + "атаки. Карта арсенала стоит места на планшете; иногда "
                + "выгоднее продать её, чем искать, куда установить.");
        }
    ...
    public static final class Разрядка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Разрядка", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                + "1 карта арсенала. Остаться без патронов страшно ровно до тех "
                + "пор, пока по тебе не начали стрелять.");
        }
    ...
    public static final class Бронебой extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Бронебой", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.действием("combat"), Награда.картаАрсенала(),
                Утиль.БОЙ,
                "В ЭТОТ ХОД уничтожь технику или авиацию врага — награда бесплатный Бой"
    ...
    public static final class ЗачисткаГекса extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Зачистка гекса", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.действием("combat"), Награда.модуль("attack"),
                Утиль.БОЙ,
                "В ЭТОТ ХОД уничтожь все жетоны врага на одном гексе — награда бесплатный Бой"
    ...
    public static final class Обесточивание extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Обесточивание", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.действием("movement"), Награда.модуль("assembly"),
                Утиль.ДВИЖЕНИЕ,
                "Имей среди уничтоженных жетонов два жетона врага — награда бесплатный Манёвр"
    ...
    public static final class ДвеВойны extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Две войны", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.действием("science"), Награда.модуль("assembly"),
                Утиль.ДВИЖЕНИЕ,
                "Имей среди уничтоженных жетонов жетоны двух разных противников — "
    ...
    public static final class ПротивСильнейшего extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Против сильнейшего", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.действием("science"), Награда.трофеи(1),
                Утиль.ДВИЖЕНИЕ,
                "В ЭТОТ ХОД уничтожь жетон игрока, у которого на поле больше войск, "
                + "чем у тебя, — награда бесплатная Наука. Если уничтоженный "
    ...
    public static final class Диверсия extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Диверсия", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.действием("mining"), Награда.трофеи(2),
                Утиль.ОБМЕН_НАУКА_ИЛИ_РЫНОК,
                "В ЭТОТ ХОД уничтожь энергостанцию противника — награда бесплатная Добыча"
    ...
    public static final class Энергосеть extends ВсеЗданияРода {
        ...
        public Лицо лицо() {
            return new Лицо("Энергосеть", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.ДВИЖЕНИЕ,
                "Имей на поле все свои 4 здания энергостанций — награда бесплатная Стройка. "
    ...
    public static final class РудныйДвор extends ВсеЗданияРода {
        ...
        public Лицо лицо() {
            return new Лицо("Рудный двор", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.действием("build"), Награда.нет(),
                Утиль.ДВИЖЕНИЕ,
                "Имей на поле все свои 4 здания добытчиков — награда бесплатная Стройка. "
    ...
    public static final class Расселение extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Расселение", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                "6 гексов",
                Награда.действием("market"), Награда.трофеи(2),
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "Займи 4 разных гекса войсками хотя бы 2 видов — награда бесплатный Рынок. "
                + "6 гексов, и условие усилено: 2 "
    ...
    public static final class Растяжка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Растяжка", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.действием("science"), Награда.картаАрсенала(),
                Утиль.РЕМОНТ_ГЕКСА,
                "Займи войсками 5 разных гексов — награда бесплатная Наука"
