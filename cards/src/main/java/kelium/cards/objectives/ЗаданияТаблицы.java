    ...
    public static final class ГолыйЗапас extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Голый запас", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.ДВИЖЕНИЕ,
                "Имей в запасе 0 войск одного вида — награда на выбор: Бой или Добыча. "
                + "Усиление — Двух видов: 1 трофей и спец-действие.");
        }
    ...
    public static final class РазносТрофеев extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разнос трофеев", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "В ЭТОТ ХОД сдай трофеи на ДВУХ разных треках технологий — награда на "
                + "выбор: Стройка или Рынок. Усиление — На трёх треках: карта арсенала и "
                + "спец-действие.");
        }
    ...
    public static final class Перестройка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Перестройка", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.трофеи(1).иСпец(1),
                Утиль.ДВИЖЕНИЕ,
                "В ЭТОТ ХОД снеси своё здание и построй другое — награда на выбор: "
                + "Смена энергии или Бой. Усиление — Построенное встало на тот же гекс, "
                + "где стояло снесённое: 1 трофей и спец-действие.");
        }
    ...
    public static final class Списание extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Списание", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                "Сбрось карту арсенала — награда на выбор: Наука или Добыча. Усиления у "
                + "карты нет.");
        }
    ...
    public static final class Разрядка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Разрядка", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                "Сдай в общий запас 2 боеприпаса — награда на выбор: Манёвр или Наука. "
                + "Усиления у карты нет.");
        }
    ...
    public static final class Бронебой extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Бронебой", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.картаАрсенала().иСпец(1),
                Утиль.БОЙ,
                "В ЭТОТ ХОД уничтожь технику или авиацию врага — награда на выбор: "
                + "Манёвр или Смена энергии. Усиление — и еще 2 жетона любого врага: "
                + "карта арсенала и спец-действие.");
        }
    ...
    public static final class ЗачисткаГекса extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Зачистка гекса", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.БОЙ,
                "В ЭТОТ ХОД уничтожь все жетоны врага на одном гексе — награда на "
                + "выбор: Манёвр или Стройка. Усиление — их на этом гексе не менее 3: "
                + "жетон модуля атаки и спец-действие.");
        }
    ...
    public static final class Обесточивание extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Обесточивание", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.ДВИЖЕНИЕ,
                "Имей среди уничтоженных жетонов два жетона врага — награда на выбор: "
                + "Наука или Стройка. Усиление — Один из них — энергостанция: жетон "
    ...
    public static final class ДвеВойны extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Две войны", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.ДВИЖЕНИЕ,
                "Имей среди уничтоженных жетонов жетоны ДВУХ разных противников — "
                + "награда на выбор: Добыча или Наука. Усиление — И оба этих жетона — "
                + "здания: жетон модуля сборки и спец-действие.");
        }
    ...
    public static final class ПротивСильнейшего extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Против сильнейшего", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.трофеи(1).иСпец(1),
                Утиль.ДВИЖЕНИЕ,
                "В ЭТОТ ХОД уничтожь жетон игрока, у которого на поле больше войск, чем "
                + "у тебя — награда на выбор: Манёвр или Рынок. Усиление — В ЭТОТ ХОД "
                + "уничтоженный жетон был техникой или авиацией: 1 трофей и "
                + "спец-действие.");
        }
    ...
    public static final class Диверсия extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Диверсия", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "В ЭТОТ ХОД уничтожь энергостанцию противника — награда на выбор: Смена "
                + "энергии или Снаряжение. Усиление — Это была энергостанция 3 или 4 "
                + "уровня: жетон модуля атаки и спец-действие.");
        }
    ...
    public static final class Энергосеть extends ВсеЗданияРода {
        ...
        public Лицо лицо() {
            return new Лицо("Энергосеть", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.ДВИЖЕНИЕ,
                "Имей на поле все свои 4 здания энергостанций — награда на выбор: Смена "
                + "энергии или Бой. Усиления у карты нет.");
        }
    }
    ...
    public static final class РудныйДвор extends ВсеЗданияРода {
        ...
        public Лицо лицо() {
            return new Лицо("Рудный двор", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.ДВИЖЕНИЕ,
                "Имей на поле все свои 4 здания добытчиков — награда на выбор: Манёвр "
                + "или Стройка. Усиления у карты нет.");
        }
    }
    ...
    public static final class Расселение extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Расселение", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                + "Добыча или Бой. Усиление — 6 гексов: 1 трофей и спец-действие.");
        }
    ...
    public static final class Растяжка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Растяжка", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.картаАрсенала().иСпец(1),
                Утиль.РЕМОНТ_ГЕКСА,
                "Займи войсками 5 разных гексов — награда на выбор: Бой или Снаряжение. "
                + "Усиление — На 2 из них есть здания противника: карта арсенала и "
                + "спец-действие.");
        }
