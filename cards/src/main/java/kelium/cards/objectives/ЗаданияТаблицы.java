    ...
    public static final class ГолыйЗапас extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Голый запас", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                + "этот ход. Если так стоят сразу два рода, условие усилено: 1 трофей и спец-действие. Вывести род целиком значит подставить его целиком: в "
    ...
    public static final class Перестройка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Перестройка", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.выбор("energy_swap", "combat"),
                Награда.трофеи(1).иСпец(1),
                Утиль.ДВИЖЕНИЕ,
                ...
                + "снесённое, условие усилено: 1 трофей и спец-действие. Здание не переезжает: его "
    ...
    public static final class Списание extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Списание", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                null,
                Награда.выбор("science", "mining"), Награда.нет(),
    ...
    public static final class Разрядка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Разрядка", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                null,
                Награда.выбор("movement", "science"), Награда.нет(),
    ...
    public static final class ПротивСильнейшего extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Против сильнейшего", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Награда.выбор("movement", "market"),
                Награда.трофеи(1).иСпец(1),
                Утиль.ДВИЖЕНИЕ,
                "В ЭТОТ ХОД уничтожь жетон игрока, у которого на поле больше войск, "
                + "чем у тебя, — награда бесплатная Наука. Если уничтоженный был "
                + "техникой или авиацией, условие усилено: 1 трофей и спец-действие. Бить сильнейшего "
    ...
    public static final class Энергосеть extends ВсеЗданияРода {
        ...
        public Лицо лицо() {
            return new Лицо("Энергосеть", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.выбор("energy_swap", "combat"), Награда.нет(),
                Утиль.ДВИЖЕНИЕ,
    ...
    public static final class РудныйДвор extends ВсеЗданияРода {
        ...
        public Лицо лицо() {
            return new Лицо("Рудный двор", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.выбор("movement", "build"), Награда.нет(),
                Утиль.ДВИЖЕНИЕ,
    ...
    public static final class Расселение extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Расселение", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.трофеи(1).иСпец(1),
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "Займи 4 разных гекса войсками хотя бы 2 видов — награда на выбор "
                + "Добыча или Бой. 6 гексов, и условие усилено: 1 трофей и спец-действие. "
                + "Растянуться по полю "
