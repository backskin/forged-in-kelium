    ...
    public static final class Отгрузка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Отгрузка", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                null,
                Награда.позолотой(), Награда.нет(),
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "Сдай два своих неоткрытых контейнера — награда позолота одного своего модуля. "
    ...
    public static final class Разоружение extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разоружение", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                Награда.позолотой(), Награда.модуль("assembly"),
                Утиль.БОЙ,
                "Верни в запас 2 своих войска с поля — награда позолота одного своего модуля. "
