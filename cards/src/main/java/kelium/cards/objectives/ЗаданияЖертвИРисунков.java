    ...
    public static final class Отгрузка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Отгрузка", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                "Сдай два своих неоткрытых контейнера — награда два спец-действия в этот ход. "
    ...
    public static final class Разоружение extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разоружение", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                Награда.спецДействиями(2), Награда.модуль("assembly"),
                Утиль.БОЙ,
                "Верни в запас 2 своих войска с поля — награда два спец-действия в этот ход. "
