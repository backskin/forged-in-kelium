...
public final class ЗаданияЖертвИРисунков {
    ...
    public static final class Отгрузка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            // ПЕЧАТНАЯ КАРТА «Расплата» № 25 (25.09.2026).
            return печатное("Отгрузка", ЖЕРТВА,
                "Сдай в общий запас 2 контейнера",
                null,
    ...
    public static final class Разоружение extends ЗаданиеВКоде {
        ...
        @Override
        public Лицо лицо() {
            // ПЕЧАТНАЯ КАРТА «Расплата» № 24 (25.09.2026).
            return печатное("Разоружение", ЖЕРТВА,
