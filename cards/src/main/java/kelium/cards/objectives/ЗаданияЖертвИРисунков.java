    ...
    public static final class Отгрузка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Отгрузка", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                null,
                Награда.монеты(3).иТрофеи(2), Награда.нет(),
                Утиль.БОЕПРИПАС_В_НАСТУПЛЕНИЕ,
                "Сдай два своих неоткрытых контейнера — награда 3 монеты и 2 трофея. "
                + "Контейнер стоит ровно столько, сколько в нём лежит, а лежит в нём "
                + "неизвестно что.");
        }
