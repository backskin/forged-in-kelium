    ...
    public static final class Отгрузка extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            ...
            return new Лицо("Отгрузка", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                null,
                Награда.спецДействиями(2), Награда.нет(),
                Утиль.ЭНЕРГИЯ_ИЛИ_МОДУЛИ,
                "Сдай два своих неоткрытых контейнера — награда два спец-действия в "
                + "этот ход. Контейнер стоит ровно столько, сколько в нём лежит, а "
                + "лежит в нём неизвестно что.");
        }
    ...
    public static final class Разоружение extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разоружение", ОБЫЧНАЯ, ЖЕРТВА,
                ...
                Утиль.БОЙ,
                "Верни в запас 2 своих войска с поля — награда два спец-действия в "
                + "этот ход. Если это техника и/или авиация и оба жетона с одного "
                + "гекса, условие усилено: 1 карта задания. Сданные войска не "
