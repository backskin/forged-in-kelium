    ...
    public static final class Биржа extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Биржа", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                + "напечатанные курсы планшета и предложения карты рынка считаются "
                + "по отдельности",
                null,
                ...
                "В ЭТОТ ХОД воспользуйся двумя разными предложениями Рынка — "
                + "напечатанные курсы планшета и предложения карты рынка считаются "
                + "по отдельности. Награда: 3 монеты. Усиления у карты нет.");
        }
    ...
    public static final class НаучныйОтдел extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Научный отдел", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                + "шаг по треку и каждый обмен трофеев на планшете технологий "
                + "считаются отдельным предложением",
                null,
                Награда.монеты(1).иБоеприпасы(2), Награда.нет(),
                Утиль.БОЕПРИПАС_В_НАСТУПЛЕНИЕ,
                "В ЭТОТ ХОД воспользуйся тремя разными предложениями Науки — шаг по "
                + "треку и каждый обмен трофеев на планшете технологий считаются "
                + "отдельным предложением. Награда: 1 монета и 2 боеприпаса. Усиления "
                + "у карты нет: обменов на планшете три, и три предложения — это ровно "
                + "все они за один ход.");
        }
    ...
    public static final class ВаБанк extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Ва-банк", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                + "боеприпас. Обнули заодно и келемий, и условие усилено: 1 трофей. Ва-банк "
