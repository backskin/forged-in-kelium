    ...
    public static final class Биржа extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Биржа", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                "В ЭТОТ ХОД воспользуйся двумя разными предложениями Рынка — награда на "
                + "выбор: Стройка или Добыча. Усиления у карты нет.");
        }
    ...
    public static final class НаучныйОтдел extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Научный отдел", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.РАЗВЁРТЫВАНИЕ,
                "В ЭТОТ ХОД воспользуйся двумя разными предложениями Науки — награда на "
                + "выбор: Снаряжение или Манёвр. Усиления у карты нет.");
        }
    ...
    public static final class НаучныйРывок extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Научный рывок", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.РАЗВЁРТЫВАНИЕ,
                "Дойди до второго шага хотя бы на одном треке технологий — награда на "
                + "выбор: Снаряжение или Смена энергии. Усиление — Стой на втором шаге "
                + "сразу на двух треках: жетон модуля атаки и спец-действие.");
        }
    ...
    public static final class ВаБанк extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Ва-банк", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.БОЕПРИПАС_В_НАСТУПЛЕНИЕ,
                "Имей одновременно ноль монет и ноль боеприпасов — награда на выбор: "
                + "Снаряжение или Рынок. Усиление — Не имей даже келемий: 1 трофей и "
                + "спец-действие.");
        }
