    ...
    public static final class НаучныйОтдел extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Научный отдел", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.РАЗВЁРТЫВАНИЕ,
                "В ЭТОТ ХОД воспользуйся тремя разными предложениями Науки. "
                + "Награда: 1 монета и 2 боеприпаса. Шаг по треку и каждый обмен "
                + "трофеев на планшете технологий считаются отдельным предложением; "
                + "обменов на планшете три, значит три предложения — это ровно все "
                + "они за один ход. Усиления у карты нет.");
        }
