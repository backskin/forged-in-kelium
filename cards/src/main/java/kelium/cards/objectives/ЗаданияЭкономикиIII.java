...
public final class ЗаданияЭкономикиIII {
    ...
    public static final class НаучныйОтдел extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Научный отдел", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                + "предложением. Награда: 2 боеприпаса и карта задания. Возьми четыре "
                + "разных предложения, и условие усилено: 4 монеты и ещё карта "
                + "задания. Больше одного шага на трек за действие не сделать — "
    ...
    public static final class НаучныйРывок extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Научный рывок", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Награда.монеты(4), Награда.модуль("assembly").иКартыАрсенала(1),
                ...
                + "усилено: жетон модуля сборки и карта арсенала. Второй шаг — первое "
     ...
     * убили её по очереди: наука стала платиться обломками (жетоны в оплату не
    ...
    public static final class Сдача extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Сдача", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                "В ЭТОТ ХОД действием Наука заплати не меньше двух обломков",
                ...
                + "два, три и четыре обломка, а прыжок через занятые ячейки "
        ...
        public String needed(CardContext ctx) {
            ...
            return есть >= 2 ? "" : "заплатить в Науку ещё " + (2 - есть) + " обломок";
        }
