...
public final class ЗаданияЭкономикиIII {
    ...
    /** o33 «Биржа» — три разных предложения планшета рынка за ход. */
    public static final class Биржа extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Биржа", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                "В ЭТОТ ХОД оплати три разных предложения на планшете рынка — "
                ...
                + "отдельности. Награда: 3 монеты. Усиления у карты нет: печатных "
                + "обменов на планшете осталось два, и три предложения набираются "
                + "впритык — два печатных плюс одно с карты.");
        }
        ...
        public String needed(CardContext ctx) {
            ...
            return есть >= 3 ? "" : "оплатить ещё " + (3 - есть) + " предложение на рынке";
        }
    ...
    public static final class НаучныйОтдел extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Научный отдел", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.БОЕПРИПАС_В_НАСТУПЛЕНИЕ,
                "В ЭТОТ ХОД воспользуйся тремя разными предложениями планшета технологий "
                + "— каждый трек и каждый вечный курс считаются отдельным предложением. "
                + "Награда: 2 монеты и 1 боеприпас. Усиления у карты нет: на планшете "
                + "науки три обмена, и три предложения — это ровно все они за один ход.");
        }
        ...
        public double progress(CardContext ctx) {
            ...
            // плюс два вечных курса стоят около четырёх трофеев, и по этому
