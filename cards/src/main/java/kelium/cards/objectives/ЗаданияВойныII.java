    ...
    public static final class НаЧужомДворе extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("На чужом дворе", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                "Имей своё войско на гексе, где есть здания врага — награда на выбор: "
                + "Бой или Добыча. Усиление — Имей на одном таком гексе два своих войска: "
    ...
    public static final class ПустойДвор extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Пустой двор", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.БОЙ,
                "Имей два своих войска на гексах, где нет твоих зданий — награда на "
                + "выбор: Стройка или Рынок. Усиление — Четыре - и все стоят на разных "
                + "гексах: жетон модуля сборки и спец-действие.");
        }
    ...
    public static final class Разорение extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Разорение", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.БОЙ,
                "В ЭТОТ ХОД уничтожь добытчик противника — награда на выбор: Добыча или "
                + "Манёвр. Усиление — Этот добытчик был полностью запитан и примыкал к "
                + "келемию: жетон модуля атаки и спец-действие.");
        }
    ...
    public static final class ОхотаНаСильного extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Охота на сильного", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                Утиль.РЕМОНТ_ГЕКСА,
                "В ЭТОТ ХОД уничтожь жетон игрока, у которого на поле больше зданий, "
                + "чем у тебя — награда на выбор: Снаряжение или Наука. Усиление — В ЭТОТ "
                + "ХОД уничтоженный жетон был зданием: 1 трофей и спец-действие.");
        }
