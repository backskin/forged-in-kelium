    ...
    public static final class НаЧужомДворе extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("На чужом дворе", ОБЫЧНАЯ, СОСТОЯНИЕ,
                ...
                Утиль.СНАРЯЖЕНИЕ,
                "Имей своё войско на гексе, где стоит здание противника, — награда "
                + "3 боеприпаса. Имей на одном таком гексе два своих войска, и "
                + "условие усилено: 1 карта арсенала. Двор чужой, а гекс общий: "
                + "здание закрывает только свои стенки, и войти во двор можно, "
                + "пока в нём есть свободный сектор.");
        }
    ...
    public static final class ОхотаНаСильного extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Охота на сильного", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                + "жетон был зданием, условие усилено: 2 трофея. Догоняющему выгодно бить того, кто оторвался, — и это "
