...
public final class ЗаданияВойныII {
     ...
     * был, его видели все, а сбитый жетон лежит в твоём месте уничтоженных жетонов.
     */
    public static final class ОтветныйУдар extends ЗаданиеВКоде {
        ...
        public Лицо лицо() {
            return new Лицо("Ответный удар", ОБЫЧНАЯ, ПРОИСШЕСТВИЕ,
                ...
                + "боях ты не потерял ни одного своего жетона, условие усилено: 3 трофея. Ответный бой случается не в "
