...
public record ЛицоСупер(String имя, String вид, String родВойска, Integer прибавкаПрочности,
    ...
    /**
     * Супер-способность набора 4.0.0: постоянное правило (знак ∞) и звёзды —
     * победные очки, пока карта у игрока (как у супер-войск 3.0.0).
     */
    public static ЛицоСупер способность4(String имя, String пассивка, int звёзд, String метка,
                                         String текстКарты, String описание) {
        return new ЛицоСупер(имя, "power", null, null, звёзд, пассивка, метка,
            null, null, текстКарты, описание);
    }
