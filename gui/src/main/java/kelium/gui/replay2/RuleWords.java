...
public final class RuleWords {
    ...
    private static String fixed(String path) {
        return switch (path) {
            ...
            case "economy.trophy_storage_vp_per_unit" ->
            ...
            case "actions.build.ops_per_military_building" ->
                "устаревший ключ: потолок операций Стройки снят 06.09.2026";
            ...
            case "actions.build.repair_enabled" ->
                "Стройкой можно снять весь урон со своего здания за его цену";
            ...
            case "tech.step_coin_prize" ->
                "монеты за ячейку ступени трека науки, по ступеням и номеру ячейки";
            case "tech.pay_with_kelium" ->
                "шаги треков науки можно оплатить келемием вместо трофеев, сколько чего — решает игрок";
