...
public final class Names {
     ...
     * краски: 0 синий, 1 красный, 2 зелёный, 3 песочный — тот же порядок, по
     * которому раздаются планшеты и жетоны.
     *
     * @param colorSlot гнездо краски места 0..3
     */
    public static String orderDeckOfColour(int colorSlot) {
        return kelium.dataio.GameConfig.orderDeckOfColour(colorSlot);
    }
}
