...
public final class Names {
    ...
    public static String vp(String key) {
        return switch (key) {
            ...
            // ПЕРВАЯ ЧАСТЬ СУПЕР-ЗАДАНИЯ и ОЧКИ ЗА УНИЧТОЖЕНИЯ появились в
            // подсчёте позже словаря, и в таблице итогов вместо них честно, но
            // бесполезно писалось «не описано» (вопрос дизайнера 13.08.2026).
