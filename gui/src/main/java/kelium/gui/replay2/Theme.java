...
public final class Theme {
    ...
    /**
     * Трофеи (правило 2026-08-15, термины слиты 30.08.2026) — чёрный кубик
     * хранилища. Раньше здесь были два разных метода на два разных термина
     * («debris» чёрный и «trophy» приглушённо-серый, для жетона ДО
     * конвертации) — второй нигде не вызывался и убран как мёртвый код вместе
     * со слиянием терминов. Иконографика: чёрный квадрат с серой шестерёнкой
     * в центре.
     */
