...
public final class Theme {
    ...
    /**
     * Обломки (правило 2026-08-15) — чёрный кубик хранилища, отличный от
     * приглушённо-серого {@link #trophy()} (та сторона жетона ДО конвертации).
     * Иконографика: чёрный квадрат с серой шестерёнкой в центре.
     */
    public static Color debris() {
