...
public final class SetupPanel extends JPanel {
    ...
    private void refreshTableButton() {
        ...
        tableButton.setToolTipText(Ui2.tip("ХАРАКТЕР бота, его УРОВЕНЬ, поворот ЦУ и "
            + "КОЛОДА приказов каждого места за столом. Планшеты у всех одинаковые: "
            + "сторон «Б» больше нет."
    ...
    public SetupPanel(Session session, Consumer<String> say) {
        ...
        // ИГРОКИ: ВСЁ хозяйство места — характер бота, его уровень, поворот ЦУ
        // и колода приказов — одним окном (просьба дизайнера 14.08.2026: раньше
        // характер и ЦУ жили СНАРУЖИ отдельной строкой, а здесь — только
        // колода; «нелогично, что часть вынесена»).
        ...
        randomAll.setToolTipText(Ui2.tip("Разом случайные: число игроков, сид, "
            ...
            + "и колоды приказов каждого места."
