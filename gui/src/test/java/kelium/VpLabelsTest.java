 ...
 * на место уничтоженных жетонов, реальный ключ разбивки — {@code "trophy"}), а ключи {@code
 * "objective_card_vp"} и {@code "arsenal_vp"} появились в подсчёте очков позже
 * словаря и не были в него добавлены вовсе. Итог: КАЖДАЯ партия с трофеями или
