...
class CardUsageTest {
    ...
    /**
     * Сколько партий гоняем в тесте.
     *
     * <p>БЫЛО 12 — и этого не хватало самому редкому счётчику, СПЕЦ-применению
     * установленной карты арсенала: на постоянном составе оно случается порядка
     * 0.4 раза за партию, то есть за 12 партий ноль выпадает и без всякой
     * поломки. Так и вышло 16.08.2026 на правилах 1.10.0: тест дал spec=0, а
     * замер на 48 партиях — 20 применений против 28 на прежних правилах, то есть
     * счётчик жив. Сорок восемь партий делают «ноль» настоящим сигналом обвала,
     * а не невезением выборки.
     */
    private static final int GAMES = 48;
