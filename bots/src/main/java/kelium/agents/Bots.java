...
public final class Bots {
     ...
     *
     * <ul>
     *   <li>{@link #НОВИЧОК} — жадная эвристика без весов линии: делает
     *       осмысленные, но близорукие ходы;</li>
     *   <li>{@link #ЛЮБИТЕЛЬ} — обученная формула, без просчёта;</li>
    ...
    public static Agent create(String character, Level level, int seat, Random rng,
        ...
        return switch (level) {
            // НОВИЧОК играет старой жадной эвристикой: она не знает весов линии и
            // смотрит на один ход вперёд — ровно то, что нужно от простого бота.
            case НОВИЧОК -> new HeuristicAgent(seat, rng, character);
