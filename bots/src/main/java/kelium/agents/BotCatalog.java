...
public final class BotCatalog {
    ...
    public static final List<Entry> СОСТАВ = List.of(
        ...
        new Entry("punisher:2", "Каратель · любитель",
            "Хочет воевать и собирает армию; ход планирует, приказ берёт по формуле"),
        new Entry("stalker:2", "Ловчий · любитель",
            "Целится в лидера и в ЦУ; ход планирует, приказ берёт по формуле"),
        new Entry("supplier:2", "Снабженец · любитель",
            "Торгует и ставит карты арсенала; ход планирует, приказ берёт по формуле"),
        new Entry("builder:2", "Зодчий · любитель",
            "Спокойно строит, выполняет задания и качает науку; ход планирует"),
    ...
    public static final List<Entry> УРОВНИ = List.of(
        new Entry("4", "гроссмейстер",
            "Планирует ход целиком: проигрывает его на копии стола во всех порядках "
                + "действий и с разными спец-действиями, приказ выбирает так же, "
                + "учитывая привычки соперников. Самый сильный и самый медленный"),
        new Entry("3", "мастер",
            "Планирует ход целиком на копии стола и выбирает приказ симуляцией; "
                + "сценариев проверяет меньше, чем гроссмейстер"),
        new Entry("2", "любитель",
            "Планирует ход на копии стола, но приказ выбирает формулой и "
                + "проверяет мало сценариев"),
        new Entry("1", "новичок",
