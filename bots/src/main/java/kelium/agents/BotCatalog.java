...
public final class BotCatalog {
     ...
     */
    public record Entry(String id, String label, String tip) {
    ...
    public static final List<Entry> ALL = List.of(
        ...
        new Entry("trained:explorer", "Обученный · исследователь",
            "Пробует за партию максимум разных механик — им проверяют, что механика вообще играется"),
        ...
        new Entry("hunter", "Ищейка дыр",
            "Ищет не победу, а выгодные повторяемые связки — им проверяют правила на дыры"),
        new Entry("simple", "Простой без обучения",
            "Жёсткие правила без генома — нижняя планка осмысленной игры"),
        new Entry("random", "Случайный",
            "Ходит наугад — нижняя планка силы вообще"));
