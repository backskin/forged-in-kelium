...
<<<<<<< HEAD
 * что построенный добытчик окажется у выработанной жилы, а вскрытая Наступление не
=======
 * что построенный добытчик окажется у выработанной жилы, а вскрытое Наступление не
>>>>>>> origin/main
...
public class SearchAgent extends StrategicAgent {
     ...
     * растраты (Стройка и Рынок на один ход выглядят убытком), и именно его не
    ...
    private Choice pickAction(GameState state, List<Choice> options,
        ...
        // минус монеты, Рынок — минус келемий), и бот перестал развиваться.
        //
