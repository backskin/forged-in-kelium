...
public final class ТемпПоРаундам {
    ...
    public static void main(String[] args) throws Exception {
        ...
        out.println("раунд | модулей бой | модулей сборка | монет | войск | снято за раунд");
        out.println("------+-------------+----------------+-------+-------+---------------");
        for (int r = 1; r <= МАКС; r++) {
            ...
            out.printf("  %2d  |    %5.2f    |     %5.2f      | %5.2f | %5.2f |     %5.2f%n",
                r, a.модулиКрасные / местВРаунде, a.модулиСиние / местВРаунде,
                a.монеты / местВРаунде, a.войскаНаПоле / местВРаунде,
                a.уничтожено / a.партий);
        }
