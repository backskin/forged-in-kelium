...
public final class Predicates {
    ...
    static {
        ...
        // ПРЯМЫХ ПОЛОС ЗДЕСЬ НЕТ СОЗНАТЕЛЬНО. Распознаватель прямых
        // (Shapes.longestStraightBand) написан и покрыт тестом, но дизайнер
        // отложил эти задания 19.08.2026: правило слишком трудно объяснить за
        // столом. Точку правил не заводим, пока нет карт, — иначе в движке
        // висел бы неиспользуемый предикат, и его пришлось бы поддерживать.
    }
