...
public abstract class Agent {
    ...
    /**
     * СПЕЦ-ДЕЙСТВИЕ — В МЕНЮ ХОДА, А НЕ ОТДЕЛЬНЫМ ВОПРОСОМ (окно партии,
     * 26.09.2026). Живому игроку движок кладёт варианты спец-действия — задания,
     * арсенал, контейнер, плашку приказа — прямо в выбор «что делаю дальше»,
     * рядом с действиями и «завершить ход», и не спрашивает о спец-действии
     * после каждого действия. Боты играют по-прежнему.
     */
    ...
    /**
     * ЖИВОЙ ИГРОК САМ ВЫБИРАЕТ СЕКТОР, на который встаёт войско (решение
     * дизайнера 26.09.2026: «выбрать, куда поставить войска, — это пиздец как
     * важно»). Сектор решает, накрыт ли печатный контейнер и с кем жетон
     * соприкасается. Боты ставят по {@link kelium.engine.СекторыВойск} сами и
     * вопроса не получают. По умолчанию — тот же признак живого игрока, что и
     * меню хода: обёртки записи и сети его уже пробрасывают.
     */
    public boolean choosesSectors() {
        return specInActionMenu();
    }
