...
class РазвязкаНичьиTest {
    ...
    private static void очистить(GameState s) {
        for (PlayerState p : s.players) {
            ...
            // СУПЕР-ЗАДАНИЯ РАЗДАЮТСЯ СЛУЧАЙНО, и карта могла посчитать очко за
            // то, что сцена оставила на столе: сторож держался зелёным лишь
            // удачным зерном и падал от любой правки, сдвигавшей раздачу
            // (пойман сменой колоды арсенала 25.09.2026). Сцена про развязку —
            // очков у сторон быть не должно вовсе.
