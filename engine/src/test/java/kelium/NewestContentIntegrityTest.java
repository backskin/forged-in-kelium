...
class NewestContentIntegrityTest {
     ...
     * без потерь. С 2026-08-15 (переименование «трофейное очко» → «обломок» +
     * обломки теперь ВСЕГДА ограничены складом наравне с келемием/боеприпасом,
     * {@code resources.debris}/{@code Storage.debrisMax}) конфликт формально
     * снят — карта уже не была бы ухудшением. Но её точную механику (доп. пул на
     * 3 обломка сверх общего бюджета? Что-то ещё?) дизайнер ещё не подтвердил —
